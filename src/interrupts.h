...
__attribute__((interrupt))
void irq3_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq4_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq5_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq6_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq7_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq8_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq9_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq10_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq11_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq12_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq13_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq14_handler(struct interrupt_frame *frame);

__attribute__((interrupt))
void irq15_handler(struct interrupt_frame *frame);
